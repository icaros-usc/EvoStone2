...
namespace SurrogateModel.Surrogate
{
    public class DeepSetModel : SurrogateBaseModel
    {
            ...
            bool testOutOfDist = false)
        {
            ...
            if (testOutOfDist)
            {
                var (deckEmbeddingOutDist, deckStatsOutDist) =
                    DataProcessor.PreprocessCardsSetOnehotFromFile(
                        offline_test_data_file, this.model_targets);
                X_out_dist = np.array(deckEmbeddingOutDist);
            ...
            bool testOutOfDist = false)
        {
            ...
            prepare_data(online: true, deckEncoding, deckStats, testOutOfDist);
            train();
        }
