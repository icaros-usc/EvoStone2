...
namespace DeckSearch.Search.RandomSearch
{
    class RandomSearchAlgorithm : SearchAlgorithm
    {
        ...
        /// </summary>
        private RandomSearchParams _params;
        ...
        public RandomSearchAlgorithm(RandomSearchParams config, string log_dir_exp)
        {
            ...
            Toml.WriteFile<RandomSearchParams>(config, config_out_path);
        ...
        {
            mapSizer = new LinearMapSizer(_params.Map.StartSize,
                                          _params.Map.EndSize);
            InitSurrogateMap(log_dir_exp);
            InitFeatureMap(_log_dir_exp);
        ...
        private void InitFeatureMap(string log_dir_exp)
        {
        ...
        private void InitSurrogateMap(string log_dir_exp)
        {
            if (_params.Map.Type.Equals("SlidingFeature"))
            {
        ...
        public Individual GenerateIndividual(List<Card> cardSet)
        {
            ...
            return Individual.GenerateRandomIndividual(cardSet);
        }
